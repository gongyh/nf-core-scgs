...
//
def softwareVersionsToYAML(version_files) {
    return version_files.unique().map { version -> processVersionsFromYAML(version) }.unique().mix(channel.of(workflowVersionToYAML()))
}
