...
from myvambtools import mykmercounts,myoverwrite_matrix
...
def numpy_inplace_maskarray(array: _np.ndarray, mask: _np.ndarray) -> _np.ndarray:
    ...
    index = myoverwrite_matrix(array, uints)
...
def torch_inplace_maskarray(array, mask):
    ...
    index = myoverwrite_matrix(np_array, np_mask)
...
class FastaEntry:
    ...
    def kmercounts(self, k: int) -> _np.ndarray:
        ...
        mykmercounts(self.sequence, k, counts)
        return counts
