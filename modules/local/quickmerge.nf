process QUICKMERGE {
    ...
    container "scgs/mulled-v2-3d7dbca3694e0bc412a351a0d57cbefcab830270:13f4c4f6b30adc2e47d2dfca9753708b5d6e5cc7-1"
    ...
    for refass_contig in \${refass_contigs[*]}; do
        merge_wrapper.py -v -t ${task.cpus} -l 0 -pre ${prefix} -ml 100 tmp.fasta \${refass_contig}
