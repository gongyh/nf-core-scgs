...
workflow.onComplete {
    ...
    def smail_fields = [ email: params.email, subject: subject, email_txt: email_txt, email_html: email_html, 
        projectDir: workflow.projectDir, mqcFile: mqc_report, mqcMaxSize: params.maxMultiqcEmailFileSize ]
